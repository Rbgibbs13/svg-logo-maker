...
describe("Shape", () => {
    test("Generate shape", () => {
        ...
        expect(nShape.title).toBe(title) && expect(nShape.color).toBe(color) && expect(nShape.borderColor).toBe(borderColor);
    });
});
...
describe("Triangle", () => {
    test("The x size and y size of the triangle should be 200", () => {
        ...
        const sizeX = 200;
        const sizeY = 200;
        const triangle = Shape.Triangle(sizeX, sizeY, data);
    ...
    describe("convertToSVG", () => {
        test("Generate Triangle SVG Text file", () => {
            ...
            const sizeX = 200;
            const sizeY = 200;
            new triangle = Shape.Triangle(sizeX, sizeY,data);
...
describe("Circle", () => {
    test("The radius of the Circle should be 100", () => {
        ...
        const radius = 100;
        new circle = Shape.Circle(radius, data);
