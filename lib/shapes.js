...
// -----------------STAR-----------------
        case "star":
            shape = 
`<svg height="${sizeX}" width="${sizeY}" xmlns="${svgNS}" version="1.1">
    <polygon points="${sizeX/2},${strokeWidth} ${sizeX*0.2},${sizeY-strokeWidth} ${sizeX-strokeWidth},${sizeY*0.375} ${strokeWidth},${sizeY*0.375} ${sizeX*0.8},${sizeY-strokeWidth}"/>
    <text><tspan font-weight="bold" fill="${borderColor}" x="${sizeX*0.35}" y="${sizeY*0.6}">${title}</tspan></text>
    <style>
        text {
